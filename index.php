                        ...
                        <div class="swiper-slide">
                            <div class="category-widgets-main card border-0 shadow-none bg-light">
                                <div class="effect">
                                    ...
                                    <div class="category-text-wrap bg-thin-dark">
                                        <h4 class="text-white">Saree Collections</h4>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-widgets-main card border-0 shadow-none bg-light">
                                <div class="effect">
                                    ...
                                    <div class="category-text-wrap bg-thin-dark">
                                        <h4 class="text-white">Kurti Collections</h4>
                                    </div>
        <!--                             <div class="widgets-wrapper position-absolute text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="category-widgets-main card border-0 shadow-none bg-light">
                                <div class="effect">
                                    ...
                                    <div class="category-text-wrap bg-thin-dark">
                                        <h4 class="text-white">Salwar Collections</h4>
                                    </div>
           <!--                          <div class="widgets-wrapper position-absolute text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="category-widgets-main card border-0 shadow-none bg-light">
                                <div class="effect">
                                    <img src="images/demo-images/category-01.png" alt="" class="img-fluid">
                                    <div class="category-text-wrap bg-thin-dark">
                                        <h4 class="text-white">Fashion Collections</h4>
                                    </div>
                           <!--          <div class="widgets-wrapper position-absolute text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="category-widgets-main card border-0 shadow-none bg-light">
                                <div class="effect">
                                    <img src="images/demo-images/category-02.png" alt="" class="img-fluid">
                                    <div class="category-text-wrap bg-thin-dark">
                                        <h4 class="text-white">Ethnic Collections</h4>
                                    </div>
                          <!--           <div class="widgets-wrapper position-absolute text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="category-widgets-main card border-0 shadow-none bg-light">
                                <div class="effect">
                                    <img src="images/demo-images/category-03.png" alt="" class="img-fluid">
                                    <div class="category-text-wrap bg-thin-dark">
                                        <h4 class="text-white">Formal Collections</h4>
                                    </div>
                             <!--        <div class="widgets-wrapper position-absolute text-center">
                ...
                <div class="swiper testi-slider">
                    <div class="swiper-wrapper my-5">
                        ...
                        <div class="swiper-slide">
                            <div class="client-box m-1">
                                <div class="client-desc p-4 border rounded">
                                    <p class="mb-0 fs-16">" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                    </p>
                                </div>
                                <div class="pt-4">
                                    <div class="d-flex align-items-center mt-0 pt-1">
                        ...
                        <div class="swiper-slide mt-5">
                            <div class="client-box m-1">
                                <div class="client-desc p-4 border rounded">
                                    <p class="mb-0 fs-16">" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s"</p>
                                </div>
                                <div class="pt-4">
                                    <div class="d-flex align-items-center mt-0 pt-1">
                                        <img src="images/users/avatar-7.jpg" alt="" class="avatar-sm rounded">
                                        <div class="flex-grow-1 ms-3">
                        ...
                        <div class="swiper-slide">
                            <div class="client-box m-1">
                                ...
                                <div class="pt-4">
                                    <div class="d-flex align-items-center mt-0 pt-1">
                                        <img src="images/users/avatar-8.jpg" alt="" class="avatar-sm rounded">
                                        <div class="flex-grow-1 ms-3">
                        ...
                        <div class="swiper-slide mt-5">
                            <div class="client-box m-1">
                                ...
                                <div class="pt-4">
                                    <div class="d-flex align-items-center mt-0 pt-1">
                                        <img src="images/users/avatar-10.jpg" alt="" class="avatar-sm rounded">
                                        <div class="flex-grow-1 ms-3">
