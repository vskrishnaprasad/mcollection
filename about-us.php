                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="position-relative">
                                <img src="images/ecommerce/img-4.jpg" alt="" class="img-fluid rounded">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="vstack gap-4">
                                <img src="images/ecommerce/img-1.jpg" alt="" class="img-fluid rounded">
                                <img src="images/ecommerce/img-3.jpg" alt="" class="img-fluid rounded">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row gy-4">
            <div class="col-xl-3 col-md-6">
                <div class="team-box text-center">
                    <div class="team-img">
                        <img src="images/users/avatar-7.jpg" alt="" class="img-fluid rounded rounded-circle border border-dashed border-dark border-opacity-25">
                    </div>
                    <div class="mt-4 pt-1">
                        <a href="#!">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="team-box text-center">
                    <div class="team-img">
                        <img src="images/users/avatar-1.jpg" alt="" class="img-fluid rounded rounded-circle border border-dashed border-dark border-opacity-25">
                    </div>
                    <div class="mt-4 pt-1">
                        <a href="#!">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="team-box text-center">
                    <div class="team-img">
                        <img src="images/users/avatar-2.jpg" alt="" class="img-fluid rounded rounded-circle border border-dashed border-dark border-opacity-25">
                    </div>
                    <div class="mt-4 pt-1">
                        <a href="#!">
                            <h5>Amanda Rivera</h5>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="team-box text-center">
                    <div class="team-img">
                        <img src="images/users/avatar-8.jpg" alt="" class="img-fluid rounded rounded-circle border border-dashed border-dark border-opacity-25">
                    </div>
                    <div class="mt-4 pt-1">
                        <a href="#!">
...
<section class="section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div>
                    <img src="images/ecommerce/img-5.jpg" alt="" class="img-fluid rounded">
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="section" style="background-image: url('images/profile-bg.jpg'); background-size: cover;background-position: center;">
